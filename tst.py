...
A4_Drawing_aspectratio=1670/2080
...
#Processes
A4_Processes_aspectratio=535/490
...
global imagep, imaged, image, p5, p4
...
for line in lines:
	...
	if globals()[ImageString+"Drawing_aspectratio"] > float(drawing.shape[0])/drawing.shape[1]:
		drawing=drawing[(drawing.shape[1]-globals()[ImageString+"Drawing_dim"][0])/2:globals()[ImageString+"Drawing_dim"][0]-(drawing.shape(1)-globals()[ImageString+"Drawing_dim"][0])/2,:]
	else:
		drawing=drawing[:,(drawing.shape[0]-globals()[ImageString+"Drawing_dim"][1])/2:globals()[ImageString+"Drawing_dim"][1])/2-(drawing.shape[0]-globals()[ImageString+"Drawing_dim"][1])/2]
	
	photo=cv2.imread('photo.'+format)
	if globals()[ImageString+"Photo_aspectratio"] > float(photo.shape[0])/photo.shape[1]:
		photo=drawing[(drawing.shape[1]-globals()[ImageString+"Drawing_dim"][0])/2:globals()[ImageString+"Drawing_dim"][0]-(drawing.shape(1)-globals()[ImageString+"Drawing_dim"][0])/2,:]
	else:
		drawing=drawing[:,(drawing.shape[0]-globals()[ImageString+"Drawing_dim"][1])/2:globals()[ImageString+"Drawing_dim"][1])/2-(drawing.shape[0]-globals()[ImageString+"Drawing_dim"][1])/2]
